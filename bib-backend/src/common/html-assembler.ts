...
export function assembleTemplateHtml(templateHtml: string, videoUrl?: string | null): string {
  ...
  const videoSection = `<section style="margin: 0; padding: 0;"><article style="max-width: 900px; margin: 0 auto; padding: 0 20px;"><video src="${video}" style="width: 100%; max-width: 900px; height: auto; display: block; margin: 0 auto;" autoplay="autoplay" loop="loop" muted="" controls="controls" width="300" height="150"></video></article></section>\n`;
...
export function assemblePageHtml(contentHtml: string, videoUrl?: string | null): string {
  ...
  const videoSection = video
    ? `<section style="margin: 0; padding: 0;"><article style="max-width: 900px; margin: 0 auto; padding: 0 20px;"><video src="${video}" style="width: 100%; max-width: 900px; height: auto; display: block; margin: 0 auto;" autoplay="autoplay" loop="loop" muted="" controls="controls" width="300" height="150"></video></article></section>\n`
    : '';

  return `${videoSection}<div style="max-width: 900px; margin: 0 auto; padding: 0 20px; text-align: left; color: #320000;">
${contentHtml}
